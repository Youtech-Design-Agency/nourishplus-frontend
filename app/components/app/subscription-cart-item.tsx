  ...
  return (
    <div className="flex gap-5 w-full items-stretch py-5">
        ...
        <div className="border rounded-lg w-20 h-20 border-text-primary-dark/20">
            <img src="/package.jpg" alt="Cart Item" className=" w-full h-full rounded-lg object-cover"/>
        </div>
        <div className="flex flex-col gap-1 my-auto">
            <span className="text-text-secondary-dark font-semibold">Basic Basket Plan</span>
            <span className="text-text-secondary-dark text-sm">N75,280.00</span>
        </div>
        <div className="flex flex-col justify-between ml-auto">
            ...
            <small className="text-green">N75,280.00</small>
        </div>
    </div>
  )
}

export default SubscriptionCartItem