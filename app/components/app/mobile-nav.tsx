...
const MobileNavigation = () => {
  return (
    <nav className="sticky lg:hidden bottom-0 shrink-0 flex items-center justify-around bg-white py-1 border-t border-text-primary-dark/10 left-0 right-0 h-20">
